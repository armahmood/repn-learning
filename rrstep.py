...
def main():
    ...
    for features in n_feature:
        if args.search and not plt_all:
            ...
            rrs1 = rrs
            #for step in ['0.3', '0.1', '0.03', '0.01', '0.003', '0.001']:
            for step in ['0.00100', '0.00300', '0.00030','0.00010','0.00003', '0.00001']:
                stds =[]
                means =[]
                for rr in ['0.010000', '0.001000', '0.000100', '0.000010', '0.000001', '0.000000']:
                    pathstr = 'experiment_leaky/leakypaper_rr' + rr +'_step'+ step +'/'
    ...
    #axes.set_ylim([2.0, 2.7])    
    #axes.set_ylim([1.3, 2.8])
    #ax1.set_ylim([2.0, 2.7])
    ax1.set_xscale('log')
    ax1.set_xticks(rrs1)
    ...
    plt.legend()
    plt.grid()
    plt.savefig("leaky100stepfinal_unscaled.svg", format="svg")
